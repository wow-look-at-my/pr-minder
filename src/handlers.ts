...
import { checkedSha, markChecked, backfilledCaps, markBackfilled, BACKFILL_CAPS, type BackfillCap, setRecheck, clearRecheck, listRechecks, setConflictCheck, clearConflictCheck, listConflictChecks, markSwept, recentlySwept } from './state';
...
// first sweep still be caught up. `conflict` rides the merge_conflict label set — the same gate the
// live path uses.
